...
Consider files in `data/source` `data/prepared` and `data/archivedived`  as immutable: its state cannot be modified after it is created. Any “change” to an immutable yields a brand-new object, leaving the original intact.
